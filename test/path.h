    ...
    AvenTestResult test_aven_path(
        ...
        switch (pargs->parts.len) {
            case 0: break;
            case 1: path = aven_path(&arena, get(pargs->parts, 0));
            break;
            case 2: path = aven_path(
                &arena,
                get(pargs->parts, 0),
                get(pargs->parts, 1)
            );
            break;
            case 3: path = aven_path(
                &arena,
                get(pargs->parts, 0),
                get(pargs->parts, 1),
                get(pargs->parts, 2)
    ...
    AvenTestResult test_aven_path_rel_diff(
        ...
        AvenStr path = aven_path_rel_diff(pargs->path1, pargs->path2, &arena);
        AvenStr expected_path = pargs->expected;
        bool match = aven_str_equals(path, expected_path);
    ...
    static int test_path(AvenArena arena) {
        AvenTestCase tcase_data[] = {
    ...
    #endif
                    .parts = slice_array(
                        (AvenStr[]){ aven_str("dir"), aven_str("a") }
                    ),
                },
            },
            {
            ...
            {
                .desc = aven_str(
                    "aven_path_containing_dir 1 level relative path"
                ),
            ...
            {
                .desc = aven_str(
                    "aven_path_containing_dir 2 level relative path"
                ),
                .fn = test_aven_path_containing_dir,
                .args = &(TestAvenPathDirArgs){
    #ifdef _WIN32
            ...
            {
                .desc = aven_str(
                    "aven_path_containing_dir 2 level absolute path"
                ),
                .fn = test_aven_path_containing_dir,
                .args = &(TestAvenPathDirArgs){
    #ifdef _WIN32
            ...
            {
                .desc = aven_str(
                    "aven_path_containing_dir filename starting w/\'.\'"
                ),
                .fn = test_aven_path_containing_dir,
                .args = &(TestAvenPathDirArgs){
                    .expected = aven_str("."),
            ...
            {
                .desc = aven_str(
                    "aven_path_containing_dir 2 level dirname starting w/\'.\'"
                ),
                .fn = test_aven_path_containing_dir,
                .args = &(TestAvenPathDirArgs){
            ...
            {
                .desc = aven_str(
                    "aven_path_rel_diff same dir rel path w/'.' prefix"
                ),
                .fn = test_aven_path_rel_diff,
                .args = &(TestAvenPathDiffArgs){
    #ifdef _WIN32
            ...
            {
                .desc = aven_str(
                    "aven_path_rel_intersect same dir relative path"
                ),
            ...
            {
                .desc = aven_str(
                    "aven_path_rel_intersect same dir rel path w/'.' prefix"
                ),
                .fn = test_aven_path_rel_intersect,
                .args = &(TestAvenPathIntersectArgs){
    #ifdef _WIN32
            ...
            {
                .desc = aven_str(
                    "aven_path_rel_intersect neighbor relative path"
                ),
                .fn = test_aven_path_rel_intersect,
                .args = &(TestAvenPathIntersectArgs){
    #ifdef _WIN32
            ...
            {
                .desc = aven_str(
                    "aven_path_rel_intersect neighbor rel path w/'.' prefix"
                ),
                .fn = test_aven_path_rel_intersect,
                .args = &(TestAvenPathIntersectArgs){
    #ifdef _WIN32
            ...
            {
                .desc = aven_str(
                    "aven_path_rel_intersect superdir relative path"
                ),
                .fn = test_aven_path_rel_intersect,
                .args = &(TestAvenPathIntersectArgs){
    #ifdef _WIN32
            ...
            {
                .desc = aven_str(
                    "aven_path_rel_intersect superdir w/\'.\' in name"
                ),
                .fn = test_aven_path_rel_intersect,
                .args = &(TestAvenPathIntersectArgs){
                    .expected = aven_str("./.a"),
